...
- Discards unused packets and flags those who use them. (PingPong, ColorChangeRequest, RequestGameStartedCooldown, TryBuyItem)
- Discards and flags packets containing NaN, Infinite, or otherwise absurd/impossible float/Vector3 values for position, rotation, and damage direction, which could lead to an unplayable state.
